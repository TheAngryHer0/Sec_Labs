...
```
![eth0 output at rest](images/05_MitigationLab/Lab5_0.png)
*at rest traffic*
...
```
![iptables rules on Kali](images/05_MitigationLab/Lab5_2_1.png)

3. **initial iptables output from rule configuration**
```bash
sudo iptables -L -n -v
```
![iptables output before flood](images/05_MitigationLab/Lab5_3.png)

4. **run hping3 on Ubuntu to simulate SYN packet flooding**
```bash
sudo hping3 -S -p 8080 --flood 10.0.2.15
```
![hping3 without flood](images/05_MitigationLab/Lab5_2.png)

5. **result iptables output after flood**
```bash
sudo iptables -L -n -v
```
![iptables output after flood](images/05_MitigationLab/Lab5_4.png)
