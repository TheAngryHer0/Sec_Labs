...
nmap -sS -p- 127.0.0.1
```
![Finding network address](images/01_PortHardeningLab/1_Lab1.png)
...
```
![Lookup all PID](images/01_PortHardeningLab/2_Lab1.png)

2. **check SMB protocol features**
```Powershell admin
Get-SmbServerConfiguration
```
![Check SMB protocol](images/01_PortHardeningLab/3_Lab1.png)
...
```
![Configure SMB settings](images/01_PortHardeningLab/4_Lab1.png)
...
nmap -sS 192.168.68.59
```
![Rescan](images/01_PortHardeningLab/5_Lab1.png)
